<template>
  <footer class="footer">
    <div class="columns">
      ...
      <div class="column">
        <h1 class="title has-text-left">Company</h1>
      ...
      <div class="column">
        <h1 class="title has-text-left">Resources</h1>
        <ul class="has-text-left">
          <li>Case Studies</li>
          <li>Partners FAQ</li>
          <li>Programming Resources</li>
          <li>Remote Team Guide</li>
          <li>Blockchain Developer Guide</li>
          <li>Best of Toptal Alternatives</li>
          <li>Remote Programming Jobs</li>
        </ul>
      </div>
      <div class="column">
        <h1 class="title has-text-left">Hire Developers</h1>
        <ul class="has-text-left">
      ...
      <div class="column">
        <h1 class="title has-text-left">Connect</h1>
        <ul class="has-text-left">
          <li>Facebook</li>
          <li>Twitter</li>
          <li>Instagram</li>
    ...
    <div class="columns">
      ...
      <div class="column">
        <p class="has-text-left">
          2019 © All rights reserved. X-Company Pty Ltd.
        </p>
      </div>
    </div>
  </footer>
...
import VClients from "./VClients.vue";
...
export default class Footer extends Vue {
  // @Prop() private|readonly propName!: propType;
}
</script>
